...
class _StateSelectionScreenState extends State<StateSelectionScreen> {
  ...
  final List<String> statesKn = [
    ...
    'ಉತ್ತರಾಖಂಡ್',
    'ಪಶ್ಚಿಮ ಬಂಗಾಳ',
    'ಆಂಡಮಾನ್ ಮತ್ತು ನಿಕೋಬಾರ್ ದ್ವೀಪಗಳು',
    'ಚಂಡೀಗಢ',
    'ದಾದ್ರಾ ಮತ್ತು ನಗರ ಹವೇಳಿ ಮತ್ತು ದಮನ್ ಮತ್ತು ದಿಯು',
    'ದೆಹಲಿ',
    'ಜಮ್ಮು ಮತ್ತು ಕಾಶ್ಮೀರ',
    'ಲಡಾಖ್',
    'ಲಕ್ಷದ್ವೀಪ',
  ...
  Widget build(BuildContext context) {
    ...
    final hint = isKannada
        ? 'ನಿಮ್ಮ ರಾಜ್ಯ/ಪ್ರದೇಶವನ್ನು ಆಯ್ಕೆಮಾಡಿ'
            ...
            child: ConstrainedBox(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(Icons.location_on, size: 48, color: Color(0xFFD74D02)),
                    SizedBox(height: 16),
                    Text(
                      title,
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: DropdownButtonFormField<String>(
                                ...
                                items: (isKannada ? statesKn : states)
