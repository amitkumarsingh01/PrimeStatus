...
class UsageTypeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final title = isKannada
        ? 'ದಯವಿಟ್ಟು ನಿಮ್ಮ ಉದ್ದೇಶವನ್ನು ಆಯ್ಕೆಮಾಡಿ'
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(fontSize: 24, color: Color(0xFFd74d02)),
                ),
                SizedBox(height: 32),
                _buildUsageCard(
                  context: context,
                  title: personalText,
                  onTap: () {
                    onboardingService.usageType = isKannada
                        ? 'ವೈಯಕ್ತಿಕ'
                        : 'Personal';
                    Navigator.push(
                      context,
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(icon, size: 40, color: Color(0xFFD74D02)),
                  SizedBox(height: 12),
                  Text(
                    title,
                    style: TextStyle(
